...
@section('title', 'Request Form - Mission Plasma')
...
<div class="container mt-5">
    <h1>Requesters Form</h1>
    <div id="alert-msg" class="alert" style="display: none;"></div>
    <form id="request-form" action="{{ route('request-submit') }}" method="post">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="error-msg" id="phone_number-error"></div>
        </div>
            ...
            if (isValid) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#request-form')[0].reset(); // Reset form fields
                        window.location.replace("{{ route('donors-list') }}"); // Redirect to donors-list
                    },
